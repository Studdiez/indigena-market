    ...
    <AdvocacyFrame title={title} subtitle={subtitle}>
      <section className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <article className="rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(18,18,18,0.96),rgba(10,10,10,0.96))] p-6">
          ...
          <h2 className="mt-2 text-2xl font-semibold text-white">Search precedent with a clearer legal strategy in mind</h2>
...
export default function CaseLawDatabasePage() {
  return (
    <ResourceCategoryShell
      title="Indigenous Rights Case Law Database"
      subtitle="Search precedents by treaty issue, jurisdiction, and outcomes."
      eyebrow="Case Law"
      intro="This collection is for users who need to move from general concern into precedent-aware legal thinking. It helps turn scattered research into something more usable for strategy, education, and briefing prep."
      statLabel="Best for"
      statValue="Researchers, legal teams, policy advocates, and community briefing leads"
      guidance="Search with a real issue in mind, then connect the precedent back to a live campaign, intake, or legal consultation rather than treating it as abstract reading."
      kind="case-law"
    />
  );
}
